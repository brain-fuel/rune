...
//
//goplus:law (Stratum[S]) CastConvertibleIsIdentity(host S)
...
//
//goplus:law (Stratum[S]) FunextReduces(host S)
...
// same equality agree.
//
//goplus:law (Stratum[S]) CastNeverInspectsProof(host S)
...
//
//goplus:law (Stratum[S]) SubstComputesAtEqualEndpoints(host S)
...
//
//goplus:instance Observational Stratum[PujetTabareau]
