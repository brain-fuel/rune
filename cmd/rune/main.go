...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "    kinds: queue kv object compute database secret nosql dns disk kms file stream cdn lb iam k8s network firewall logs registry paas")
