...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "  rune deploy --resource queue|kv|object|compute|database|secret|nosql|dns|disk|kms --name <n> --backend <b> [--out dir] [--replicas N] [--image ref] [--fifo]")
