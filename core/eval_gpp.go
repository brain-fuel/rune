// Code generated by gpp from eval.gpp. DO NOT EDIT.
//gpp:v v0.14.0
...
func (m *Machine) Eval(env Env, t Tm) Val {
	...
	case Pi:
		...
		cod := __gpp_m0.Cod
		dom := m.Eval(env, domT)
		return VPi{Name: cod.Name, Icit: icit, Qty: qty, NonDep: !usesVar(cod.Body, 0), Dom: dom, Cod: func(v Val) Val {
	...
	case Lam:
		...
		qty := __gpp_m0.Qty
		body := __gpp_m0.Body
		return VLam{Name: body.Name, Icit: icit, Qty: qty, Body: func(v Val) Val {
	...
	case Sig:
		...
		domT := __gpp_m0.Dom
		cod := __gpp_m0.Cod
		return VSig{Name: cod.Name, Qty: qty, Dom: m.Eval(env, domT), Cod: func(v Val) Val { return m.Eval(env.Extend(v), cod.Body) }}
	case Pair:
		domT := __gpp_m0.Dom
		cod := __gpp_m0.Cod
		a := __gpp_m0.A
		b := __gpp_m0.B
		return VPair{Name: cod.Name, Dom: m.Eval(env, domT), Cod: func(v Val) Val { return m.Eval(env.Extend(v), cod.Body) }, A: m.Eval(env, a), B: m.Eval(env, b)}
	case Fst:
		p := __gpp_m0.P
...
func (m *Machine) proj2(v Val) Val {
	...
	case VPair:
		...
		return b
	case VNeu:
		spine := __gpp_m2.Spine
		unfold := __gpp_m2.Unfold
...
func (m *Machine) apply(fn, arg Val, icit Icit) Val {
	switch __gpp_m3 := any(fn).(type) {
	case VLam:
		body := __gpp_m3.Body
		return body(arg)
	case VNeu:
		spine := __gpp_m3.Spine
		unfold := __gpp_m3.Unfold
