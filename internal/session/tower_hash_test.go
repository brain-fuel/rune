...
func TestTowerClassHashesDistinct(t *testing.T) {
	...
	names := []string{"Semiring", "Ring", "DivRing", "Magma", "Monoid", "Group", "Div", "NegR", "SubR", "Binary", "Show", "DecEq", "Ord", "Ordering", "OrderedSemiringLaws", "OrderedRingLaws", "OrderedFieldLaws"}
